...
public class AuditService {
    ...
    // public AuditService(String message, String source, AuditType type, LogTarget
    // target, User user) {
    ...
    private void logToDatabase() {
        ...
        // } catch (Exception e) {
        // logger.log(Level.SEVERE, "Failed to log audit to database: {0}",
        // e.getMessage());
    ...
    private void logToFile() {
        ...
        try {
            ...
            logger.log(Level.SEVERE, "Failed to log audit to file ''{0}'': {1}",
